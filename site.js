async function getResponce() {
    ...
    for (key in content) {
        ...
        <p class="card-text">${content[key].description}. Стаж ${content[key].price} </p>
        <input type="hidden" name= "vendor_code" value=${content[key].vendor_code}>
        <p class="card-text" >Заказать <input class="form-control" type="number" name="amount" value="0"></p>
        </li>
                `
    }
